...
const checks = [
  ...
  ["botbooru listing", "https://botbooru.com/posts/?offset=0&limit=1&sort=latest", b => Array.isArray(b.posts) && b.posts[0] && typeof b.posts[0].character_name === "string" && Number.isFinite(b.total)],
